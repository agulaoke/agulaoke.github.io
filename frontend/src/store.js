...
const SAMPLE_DATA = {
  topics: [
    ...
    { id: 'tp006', title: "沃顿谈判课：女生最该学的不是妥协，是不等价交换", source_domain: '谈判/心理学', target_audience: '女性', difficulty: 'medium', status: 'in_progress', tags: ['认知', '女性成长', '人际关系'], notes: '读《沃顿商学院最受欢迎的谈判课》，提取反常识精华：折中是最偷懒的谈判方式、不等价交换、不要讲道理要问问题。用女性日常场景切入。', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ],
  inspirations: [
  ...
  scripts: [
    ...
    {
      id: 'sc004', title: '沃顿谈判课：你每一次妥协，都在告诉对方——我不值钱',
      hook: '我最近读了本书，读完之后只有一个感觉——亏大了。不是后悔没早点读，是突然发现，我以前在每一段关系里做的那些"算了算了"，原来都是亏本买卖。',
      pain_point: '你们有没有这种感觉：跟男朋友吵架，最后你说"算了"；跟同事意见不合，你主动退一步；跟爸妈争一件事，你又妥协了。然后你还要安慰自己——"我这是情商高"、"我不跟他一般见识"。但你知道我在想什么吗？我在想，凭什么每次退的都是我？',
      concept_bridge: '这本书叫《沃顿商学院最受欢迎的谈判课》。别被"谈判"两个字吓到——它不是教你怎么吵赢别人。它是教你一个道理：你不需要变得强硬，也能拿到你想要的东西。书里有一个点，我读到的时候真的愣了一下。它说——折中，是谈判里最偷懒的方式。就是我们最擅长的"各退一步"嘛。但"各退一步"不是智慧，是你懒得动脑子。你没有认真想过——有没有第三种方案，两个人都能拿到自己想要的？你只是选了一条最省事的路，然后跟自己说"我大度"。',
      case_study: '书里还提了一个概念，叫"不等价交换"，这个我觉得是所有女生都该刻在脑子里的。什么意思呢？有些东西对你来说不值钱，但对别人是宝藏。反过来也是。我给你举个例子：你男朋友老让你早点回家，你跟他吵"我有人身自由"，吵不出个结果对吧？但你有没有想过——他真正想要的，可能不是控制你几点回家，而是"感觉自己被你放在心上"。你只需要出门前发一句"我到了跟你说"，或者中途回一条微信。你花的是十秒钟，换回来的是整晚的自由。这就叫不等价交换。你不是在妥协，你是在用一个他不值钱但你很富余的东西，换一个他特别在意的东西。',
      closing: '读完这本书，我现在每次想说"算了"的时候，都会停下来问自己一句——"有没有第三种可能？"不是因为我不愿意让步。是因为我发现自己以前那些无意识的妥协，每一次都在跟这个世界说：我不配拿到更多。如果你也总是那个先低头的人，我建议你去翻翻这本书。或者，至少从今天开始，试试这句话——"有没有第三种可能？"评论区聊聊，你上一次说"算了"，是真的算了，还是不敢要？',
      full_text: '',
      target_duration: 180, status: 'ready',
      created_at: new Date().toISOString(), updated_at: new Date().toISOString(),
    },
  ],
  videos: [],
